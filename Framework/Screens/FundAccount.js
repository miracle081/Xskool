                    ...
                    {(prop) => {
                        return (
                            <View style={styles.form}>
                                ...
                                <Text style={styles.placeholder}>Please enter an amount you want to fund your account with.</Text>
                        ...
                        <View style={{ backgroundColor: "#fcfbff", borderTopRightRadius: 20, borderTopLeftRadius: 20 }}>
                            <View style={{ alignItems: 'flex-end', margin: 10 }}>
                                <TouchableOpacity onPress={closeModal}>
                                    <FontAwesomeIcon icon={faXmark} size={24} color='#787A8D' />
                                </TouchableOpacity>
                            </View>
                            <View style={{ marginBottom: 20 }}>
                                ...
                                <View style={{ marginTop: 20, margin: 15, }}>
                                    ...
                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        ...
                                        <Text style={[styles.modalText, { color: Theme.colors.text1, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>Paystack(ATM Card)</Text>
                                    </View>

                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        <Text style={styles.modalText}>Fee (1.8%)</Text>
                                        <Text style={[styles.modalText, { color: Theme.colors.text1, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>₦{formatMoney((1.8 / 100) * amount)}</Text>
                                    </View>

                                    <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                                        <Text style={styles.modalText}>Amount</Text>
                                        <Text style={[styles.modalText, { color: Theme.colors.text1, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>₦{formatMoney(amount)}</Text>
                                    </View>
                                    ...
                                    <TouchableOpacity onPress={() => { closeModal(); navigation.navigate("Pay", { amount }) }} style={styles.appBTN}>
